...
public class UserDAO {
    ...
    private final String jdbcURL = "jdbc:postgresql://" + DOTENV.get("POSTGRES_HOST") + ":" + DOTENV.get("POSTGRES_HOST_PORT") + "/" + DOTENV.get("POSTGRES_DATABASE");
    private final String jdbcUsername = DOTENV.get("POSTGRES_USER");
    private final String jdbcPassword = DOTENV.get("POSTGRES_PASSWORD");
